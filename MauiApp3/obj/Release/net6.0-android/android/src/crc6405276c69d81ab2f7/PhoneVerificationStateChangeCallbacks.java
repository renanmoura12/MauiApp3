...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Plugin.Firebase.Android.Auth.PhoneNumber.PhoneVerificationStateChangeCallbacks, Plugin.Firebase", PhoneVerificationStateChangeCallbacks.class, __md_methods);
	}
	...
	public PhoneVerificationStateChangeCallbacks ()
	{
		...
		if (getClass () == PhoneVerificationStateChangeCallbacks.class)
			mono.android.TypeManager.Activate ("Plugin.Firebase.Android.Auth.PhoneNumber.PhoneVerificationStateChangeCallbacks, Plugin.Firebase", "", this, new java.lang.Object[] {  });
	}
